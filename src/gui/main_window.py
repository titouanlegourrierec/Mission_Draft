...
class App:
    ...
    def _setup_notebook(self):
        ...
        self.splitter_tab.output_dir.trace_add(
            "write", lambda *args: sync_segmenter_input()
        )

        # Trace changes to splitter DPI value
        self.splitter_tab.dpi_value.trace_add("write", lambda *args: sync_dpi_value())
